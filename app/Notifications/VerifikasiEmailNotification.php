...
class VerifikasiEmailNotification extends Notification
{
    ...
    public function toMail($notifiable)
    {
        ...
        return (new MailMessage)
            ...
            ->line('Selamat datang di platform kami. Silakan klik tombol di bawah ini untuk memverifikasi alamat email Anda.')
            ...
            ->salutation('Terima kasih telah bergabung dengan kami!');
    }
